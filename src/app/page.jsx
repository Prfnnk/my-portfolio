...
export default function Home() {
  const sectionsArr = ['greet', 'about', 'skills', 'projects', 'hobbies', 'contact'];
  ...
  return (
    <main className="main">
      <Nav navArr={sectionsArr} entryId={entryId} sectionScrollY={sectionScrollY}/>
      {sectionsArr.map((title, index) => (
        <Section refProp={cbRef} key={index} title={title} setSectionScrollY={setSectionScrollY} sectionScrollY={sectionScrollY} />
      ))}
    </main>
  );
}